...
#define __uqmi_wms_commands \
    __uqmi_command(wms_set_mode, list-messages, no, CMD_TYPE_OPTION), \
    __uqmi_command(wms_set_storage, list-messages, no, CMD_TYPE_OPTION), \
...
#define wms_helptext \
        "  --wms-mode <mode>                 Message Mode (CDMA or GSM)\n" \
        "  --wms-storage <storage>           Preferred Message Storage (SM or ME)\n" \
